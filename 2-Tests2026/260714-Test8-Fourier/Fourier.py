...
def aux_animacion_atenuacion_modos(numero_de_cuadro):
    ...
    gfx.set_ylim(-50, 50)  # Pueden ajustar según sea necesario
...
u=0 # The strategy to compute the summation consists
...
print(f"The temperature at the point with coordinate x={x}, at the instant t={t}, will be of {u:.2f} degrees.")